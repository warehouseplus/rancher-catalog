...
services:
  php:
    image: 575062673063.dkr.ecr.eu-central-1.amazonaws.com/warehouseplus/api:1.3.4
    environment:
      SYMFONY_ENV: prod
  ...
  portal:
    image: 575062673063.dkr.ecr.eu-central-1.amazonaws.com/warehouseplus/admin:1.1.3
    environment:
