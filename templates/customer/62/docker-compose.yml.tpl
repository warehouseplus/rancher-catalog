...
services:
  php:
    image: 575062673063.dkr.ecr.eu-central-1.amazonaws.com/warehouseplus/api:1.12.2
    environment:
      SYMFONY_ENV: prod
      SYMFONY__VERSION_TAG: 1.12.2
...
{{ .Values.api_labels | indent 6 }}
  ...
  portal:
    image: 575062673063.dkr.ecr.eu-central-1.amazonaws.com/warehouseplus/admin:1.9.0
    environment:
