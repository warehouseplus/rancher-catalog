...
services:
  php:
    image: 575062673063.dkr.ecr.eu-central-1.amazonaws.com/warehouseplus/api:1.3.1
    environment:
      SYMFONY_ENV: prod
      SYMFONY__VERSION_TAG: 1.3.1
      SYMFONY__DATABASE_HOST: database
      SYMFONY__DATABASE_NAME: ${account_identifier}
      SYMFONY__DATABASE_USER: ${account_identifier}
  ...
  portal:
    image: 575062673063.dkr.ecr.eu-central-1.amazonaws.com/warehouseplus/admin:1.1.1
    environment:
  ...
  mysql:
    ...
    environment:
      ...
      MYSQL_DATABASE: ${account_identifier}
      MYSQL_USER: ${account_identifier}
      MYSQL_PASSWORD: ${database_password}
    volumes:
    - {{.Values.account_identifier}}_mysql_data:/var/lib/mysql
    labels:
      io.rancher.container.pull_image: always
volumes:
  {{.Values.account_identifier}}_mysql_data:
    external: true
    driver: ${storage_driver}
    driver_opts:
      {{.Values.storage_driver_options}}
