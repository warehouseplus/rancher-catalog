...
services:
  php:
    image: 575062673063.dkr.ecr.eu-central-1.amazonaws.com/warehouseplus/api:1.18.0
    environment:
      SYMFONY_ENV: prod
      SYMFONY__VERSION_TAG: 1.18.0
...
{{ .Values.api_labels | indent 6 }}
  ...
  portal:
    image: 575062673063.dkr.ecr.eu-central-1.amazonaws.com/warehouseplus/admin:1.15.8
    environment:
      REACT_APP_VERSION: 1.15.8
