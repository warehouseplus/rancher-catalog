...
services:
  php:
    image: 575062673063.dkr.ecr.eu-central-1.amazonaws.com/warehouseplus/open-api:0.0.14
    environment:
      APP_NAME: ${account_identifier}
      APP_ENV: prod
      APP_KEY: "${base64_key}"
      APP_VERSION_TAG: 0.0.14
...
{{ .Values.api_labels | indent 6 }}
  ...
  portal:
    image: 575062673063.dkr.ecr.eu-central-1.amazonaws.com/warehouseplus/admin:1.22.0
    environment:
      REACT_APP_VERSION: 1.22.0
